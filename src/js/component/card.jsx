...
function Card(props){
    ...
    <img src={props.carta.imageUrl} className="card-img-top" alt="..."/>
    <div className="card-body">
      <h5 className="card-title">{props.carta.title}</h5>
      <p className="card-text">{props.carta.description}</p>
      <a href="#" className="btn btn-primary">{props.carta.buttonLabel}</a>
    </div>
  </div>
}
